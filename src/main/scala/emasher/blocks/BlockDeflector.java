...
public class BlockDeflector extends BlockPane {
	...
	protected BlockDeflector() {
		super( "eng_toolbox:deflector_edge", "eng_toolbox:deflector_edge", Material.circuits, false );
	...
	public void registerBlockIcons( IIconRegister register ) {
		...
		this.blockIcon = register.registerIcon( "eng_toolbox:deflector_edge" );
		this.shieldHigh = register.registerIcon( "eng_toolbox:deflector_high" );
		this.shieldLow = register.registerIcon( "eng_toolbox:deflector_low" );
	}
	...
	public void onNeighborBlockChange( World world, int x, int y, int z, Block block ) {
		...
		if( lower == this || lower == emasher.blocks.Blocks.deflectorBase() ) {
			if( lower == this ) {
