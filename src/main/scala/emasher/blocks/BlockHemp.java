...
public class BlockHemp extends Block {
	...
	public void registerBlockIcons( IIconRegister par1IconRegister ) {
		this.blockIcon = par1IconRegister.registerIcon( "eng_toolbox:hemp" );
	}
	...
	public Item getItemDropped( int i, Random random, int j ) {
		return emasher.items.Items.hempPlant();
	}
	...
	public boolean canPlaceBlockAt( World world, int i, int j, int k ) {
		...
		if( l == Blocks.grass || l == Blocks.dirt || l == Blocks.gravel || l == Blocks.sand || l == emasher.blocks.Blocks.mixedDirt() || l == emasher.blocks.Blocks.mixedSand() || l == this ) {
			toReturn = true;
		}
