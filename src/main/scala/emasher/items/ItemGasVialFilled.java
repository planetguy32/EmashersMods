...
public class ItemGasVialFilled extends Item {
	...
	public void registerIcons( IIconRegister ir ) {
		...
		textures[0] = ir.registerIcon( "eng_toolbox:naturalGasVial" );
		textures[1] = ir.registerIcon( "eng_toolbox:propellentVial" );
		textures[2] = ir.registerIcon( "eng_toolbox:hydrogenVial" );
		textures[3] = ir.registerIcon( "eng_toolbox:smokeVial" );
		textures[4] = ir.registerIcon( "eng_toolbox:toxicGasVial" );
		textures[5] = ir.registerIcon( "eng_toolbox:neurotoxinVial" );
		textures[6] = ir.registerIcon( "eng_toolbox:corrosiveGasVial" );
		textures[7] = ir.registerIcon( "eng_toolbox:plasmaVial" );
	...
	public FluidStack getFluid( ItemStack stack ) {
		...
		switch(meta) {
			case 0:
				return new FluidStack( emasher.fluids.Fluids.fluidNaturalGas(), v );
			case 1:
				return new FluidStack( emasher.fluids.Fluids.fluidPropellent(), v );
			case 2:
				return new FluidStack( emasher.fluids.Fluids.fluidHydrogen(), v );
			case 3:
				return new FluidStack( emasher.fluids.Fluids.fluidSmoke(), v );
			case 4:
				return new FluidStack( emasher.fluids.Fluids.fluidToxicGas(), v );
			case 5:
				return new FluidStack( emasher.fluids.Fluids.fluidNeurotoxin(), v );
			case 6:
				return new FluidStack( emasher.fluids.Fluids.fluidCorrosiveGas(), v );
			case 7:
				return new FluidStack( emasher.fluids.Fluids.fluidPlasma(), v );
			default:
				return new FluidStack( emasher.fluids.Fluids.fluidNaturalGas(), v );
		}
	}
		...
		if( var12 == null ) {
			...
			if( b == Blocks.air && !( block instanceof IFluidHandler ) ) {
				...
				if( !par3EntityPlayer.capabilities.isCreativeMode ) {
					...
					return ( new ItemStack( emasher.items.Items.vial(), 1, 0 ) );
				} else {
					return par1ItemStack;
				}
