...
public class ModAdvancedBreaker extends SocketModule {
	...
	public ModAdvancedBreaker( int id ) {
		super( id, "eng_toolbox:advanced_breaker" );
	}
	...
	public void getIndicatorKey( List l ) {
		...
		l.add( emasher.util.Config.PREF_DARK_PURPLE() + "RS Latch Activation Pulse" );
		l.add( emasher.util.Config.PREF_YELLOW() + "Extra output sent to machine output" );
	}
	
	@Override
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "t", "b", Character.valueOf( 't' ), Items.diamond, Character.valueOf( 'r' ), Items.redstone,
				Character.valueOf( 'b' ), new ItemStack( emasher.items.Items.module(), 1, 65 ) );
	}
