...
public class ModBreaker extends SocketModule {
	...
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "ipi", "ici", " b ", Character.valueOf( 'i' ), Items.iron_ingot, Character.valueOf( 'p' ), Items.iron_pickaxe, Character.valueOf( 'c' ),
				Blocks.dispenser, Character.valueOf( 'b' ), emasher.items.Items.blankSide() );
	}
