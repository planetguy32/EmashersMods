...
class ModElevator( id: Int ) extends SocketModule( id, "eng_toolbox:elevatorUp", "eng_toolbox:elevatorDown" ) {
  ...
  override def addRecipe( ): Unit = {
    CraftingManager.getInstance( ).getRecipeList.asInstanceOf[ java.util.List[ Object ] ]
      .add( new ShapedOreRecipe( new ItemStack( emasher.items.Items.module, 2, moduleID ), "gmg",
  ...
  override def getIndicatorKey( l: java.util.List[ Object ] ): Unit = {
    ...
    l.add( emasher.util.Config.PREF_WHITE + "Change Mode" )
  }
