...
public class ModFreezer extends SocketModule {
	...
	public void getIndicatorKey( List l ) {
		...
		l.add( emasher.util.Config.PREF_AQUA() + "Requires 160 RF/operation" );
	}
	...
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "wpw", " b ", 'w', Items.bucket,
				'p', emasher.items.Items.psu(), 'b', emasher.items.Items.blankSide() );
	}
