...
public class ModGasVent extends SocketModule {
	...
	public void addRecipe() {
		CraftingManager.getInstance().getRecipeList().add( new ShapedOreRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "civ", " b ", Character.valueOf( 'c' ), emasher.items.Items.circuit(), Character.valueOf( 'i' ), Blocks.iron_bars,
				Character.valueOf( 'v' ), Blocks.hopper, Character.valueOf( 'b' ), new ItemStack( emasher.items.Items.module(), 1, 5 ) ) );
	}
