...
public class ModInternalClock extends SocketModule {
	...
	public void getIndicatorKey( List l ) {
		l.add( emasher.util.Config.PREF_RED() + "Output Channel" );
		l.add( emasher.util.Config.PREF_WHITE() + "Modify length of delay" );
	}

	@Override
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "b",
				Character.valueOf( 'b' ), new ItemStack( emasher.items.Items.module(), 1, 35 ) );
	}
	...
	public String getInternalTexture( SocketTileAccess ts, SideConfig config, ForgeDirection side ) {
		...
		if( timer == 0 ) return "eng_toolbox:inner_latch_inactive";
		return "eng_toolbox:inner_latch_active";
	}

	@SideOnly( Side.CLIENT )
	public String[] getAllInternalTextures() {
		return new String[] {
				"eng_toolbox:inner_latch_inactive",
				"eng_toolbox:inner_latch_active"
		};
	}
