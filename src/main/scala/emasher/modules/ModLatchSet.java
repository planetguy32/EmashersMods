...
public class ModLatchSet extends SocketModule {
	...
	public void getIndicatorKey( List l ) {
		l.add( emasher.util.Config.PREF_DARK_PURPLE() + "RS latches to turn on" );
	}
	
	@Override
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "rgt", " b ", Character.valueOf( 't' ), Blocks.redstone_torch, Character.valueOf( 'r' ), Items.redstone,
				Character.valueOf( 'g' ), Items.gold_ingot, Character.valueOf( 'b' ), new ItemStack( emasher.items.Items.module(), 1, 16 ) );
	}
