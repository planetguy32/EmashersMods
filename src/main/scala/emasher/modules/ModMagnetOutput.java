...
public class ModMagnetOutput extends ModMagnet {
	public ModMagnetOutput( int id ) {
		super( id, "eng_toolbox:magnetOutput" );
	}
	...
	public void getIndicatorKey( List l ) {
		...
		l.add( emasher.util.Config.PREF_RED() + "Magnet Enabled" );
		l.add( emasher.util.Config.PREF_DARK_PURPLE() + "Magnet Enabled" );
	}

	@Override
	public void addRecipe() {
		GameRegistry.addShapelessRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), new ItemStack( emasher.items.Items.module(), 1, 10 ), new ItemStack( emasher.items.Items.module(), 1, 47 ) );
	}
