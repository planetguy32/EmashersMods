...
public class ModMultiOutput extends SocketModule {
	...
	public ModMultiOutput( int id ) {
		super( id, "eng_toolbox:multiOutput" );
	}
	...
	public void addRecipe() {
		GameRegistry.addShapelessRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), new ItemStack( emasher.items.Items.module(), 1, 2 ), new ItemStack( emasher.items.Items.module(), 1, 5 ), new ItemStack( emasher.items.Items.module(), 1, 8 ) );
	}
