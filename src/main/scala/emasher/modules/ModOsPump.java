...
public class ModOsPump extends SocketModule {
	...
	public void getIndicatorKey( List l ) {
		l.add( emasher.util.Config.PREF_BLUE() + "Output tank" );
	}
	...
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "iti", " b ", Character.valueOf( 't' ), Blocks.iron_bars, Character.valueOf( 'i' ), Items.iron_ingot,
				Character.valueOf( 'b' ), emasher.items.Items.blankSide() );
		
		CraftingManager.getInstance().getRecipeList().add( new ShapedOreRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "iti", " b ", Character.valueOf( 't' ), Blocks.iron_bars, Character.valueOf( 'i' ), "ingotAluminum",
				Character.valueOf( 'b' ), emasher.items.Items.blankSide() ) );
		CraftingManager.getInstance().getRecipeList().add( new ShapedOreRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "iti", " b ", Character.valueOf( 't' ), Blocks.iron_bars, Character.valueOf( 'i' ), "ingotTin",
				Character.valueOf( 'b' ), emasher.items.Items.blankSide() ) );
	}
