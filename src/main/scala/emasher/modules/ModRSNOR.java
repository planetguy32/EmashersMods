...
public class ModRSNOR extends RSGateModule {
	...
	public void addRecipe() {
		GameRegistry.addShapelessRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), new ItemStack( emasher.items.Items.module(), 1, 20 ) );
	}
