...
public class ModStateCell extends SocketModule {
	...
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "rtr", " b ", Character.valueOf( 't' ), Items.clock, Character.valueOf( 'r' ), Blocks.redstone_torch,
