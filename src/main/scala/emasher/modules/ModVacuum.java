...
public class ModVacuum extends SocketModule {
	...
	public void getIndicatorKey( List l ) {
		l.add( emasher.util.Config.PREF_GREEN() + "Inventory to input items to" );
		l.add( emasher.util.Config.PREF_RED() + "RS control channel" );
		l.add( emasher.util.Config.PREF_AQUA() + "Uses 10 RF/Operation" );
	}
	...
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), " s ", "ipi", " b ", Character.valueOf( 'i' ), Items.iron_ingot, Character.valueOf( 's' ), Blocks.hopper,
