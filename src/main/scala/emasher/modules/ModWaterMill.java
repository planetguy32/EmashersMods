...
public class ModWaterMill extends SocketModule {
	...
	public void getIndicatorKey( List l ) {
		l.add( emasher.util.Config.PREF_AQUA() + "Generates 10 RF/t" );
	...
	public void addRecipe() {
		GameRegistry.addShapedRecipe( new ItemStack( emasher.items.Items.module(), 1, moduleID ), "sps", "sps", "sbs", Character.valueOf( 's' ), Blocks.heavy_weighted_pressure_plate, Character.valueOf( 'p' ), emasher.items.Items.psu(),
