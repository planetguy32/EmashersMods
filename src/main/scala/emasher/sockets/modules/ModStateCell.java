...
public class ModStateCell extends SocketModule
{
	...
	{
		GameRegistry.addShapedRecipe(new ItemStack(SocketsMod.module, 1, moduleID), "rtr", " b ", Character.valueOf('t'), Items.clock, Character.valueOf('r'), Blocks.redstone_torch,
