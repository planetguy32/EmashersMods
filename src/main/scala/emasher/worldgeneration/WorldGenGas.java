	...
	public void generate( Random random, int i, int k, World world, IChunkProvider provider, IChunkProvider provider2 ) {
		if( random.nextInt( 8 ) == 0 ) {
			...
			if( world.provider.dimensionId != -1 ) {
				if( world.getBlock( x, y, z ) == Blocks.stone ) world.setBlock( x, y, z, emasher.blocks.Blocks.gasPocket() );
			} else {
				if( world.getBlock( x, y, z ) == Blocks.netherrack ) world.setBlock( x, y, z, emasher.blocks.Blocks.plasmaPocket() );
			}
